...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{plots/hese_events_per_sample_skymap.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{plots/unsmoothed_vs_smoothed.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{plots/untruncated_vs_truncated.pdf}
