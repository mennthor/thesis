...
For the scan procedure, the sky is binned in a HEALPix pixelization scheme in a three pass procedure \cite{Gorski:2004by}.
...
\begin{table}[htbp]
\centering
\caption[Time and angular position for the 22 HESE events]{
