...
For simulated signal data, the number of events per bin can be computed using the modified OneWeight \footnote{See previous chapters for a more detailed introduction of OneWeight.}
\begin{equation}
