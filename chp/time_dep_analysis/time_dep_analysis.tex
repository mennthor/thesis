...
\FIXME{Longer summary of time dependent source searches!}
...
\FIXME{Robust physics scenario motivation}
...
This corresponds to typical scales of fast transient sources with the potential of also having neutrino emission, like Gamma Ray and Fast Radio Burst or tidal disruption events \FIXME{Look up correct values}\CITE{Paper on GRB, TDE scales}.
...
By doing the grid scan in 21 different time windows, a trial factor needs to be regarded \CITE{LLH methods for HE Phys?}.
