...
To build a custom background PDF for each source in its respective sample, first all events in each sample are binned uniformly spaced in $\sin(\delta)$ in $\num{20}$ bins.
...
\begin{figure}[htbp]
  \centering
  \includegraphics{../time_dep_analysis/plots/bg_pdf_per_sample.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics{../time_dep_analysis/plots/energy_pdfs.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics{../time_dep_analysis/plots/bg_ts_and_ks_tw_ids_0_1_2.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics{../time_dep_analysis/plots/bg_ts_and_ks_tw_ids_18_19_20.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics{../time_dep_analysis/plots/perf.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics{../time_dep_analysis/plots/diff_perf.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics{../time_dep_analysis/plots/post_trial_pre_trial.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics{../time_dep_analysis/plots/exp_res_bg_pdf_post_pdf.pdf}
