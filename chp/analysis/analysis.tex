...
The free parameters are amplitude $\mathcal{A}$ and average rate $R_0$ both in $\si{\per\s}$.
...
The energy PDFs introduce a significant amount of separation power compared to using the spatial clustering only \CITE{Braun Paper}.
The integral values
\begin{equation}
